      ...
      <div className="flex flex-col justify-between">
        <div>
          <div className="flex flex-row space-x-4 mb-4 relative">
            ...
            <p className="0 text-sm">{company}</p>
          </div>
          <h4 className="font-bold text-base md:text-xl tracking-tight  mb-2">
            {title}
          </h4>
          <p className=" text-sm">{description}</p>
          <p className=" group-hover:text-cyan-500 transition duration-200 text-sm mt-2 inline-block">
